...
namespace bmla {
	...
	****************************************/
	...
	// Get from the dict
	double BiasDict::get_ixn(Sptr sp) const {
	...
	****************************************/
	...
	// Get from the dict
	double O2IxnDict::Impl::get_ixn(Sptr sp_of_site_1, Sptr sp_of_site_2) const {
	...
	double O2IxnDict::get_ixn(Sptr sp_of_site_1, Sptr sp_of_site_2) const {
		return _impl->get_ixn(sp_of_site_1,sp_of_site_2);
	};
	...
	****************************************/
	...
	// Get from the dict
	double O3IxnDict::Impl::get_ixn(Sptr sp_of_site_1, Sptr sp_of_site_2, Sptr sp_of_site_3) const {
		auto it1 = _dict.find(sp_of_site_1);
		if (it1 == _dict.end()) {
			return 0.0;
		};
	...
	// Get from the dict forward
	double O3IxnDict::get_ixn(Sptr sp_of_site_1, Sptr sp_of_site_2, Sptr sp_of_site_3) const {
		return _impl->get_ixn(sp_of_site_1,sp_of_site_2,sp_of_site_3);
	};
