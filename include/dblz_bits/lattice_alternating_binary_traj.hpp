...
namespace dblz {
	...
	****************************************/
	...
	private:
		...
		void _clean_up();
		void _move(LatticeAlternatingBinaryTraj& other);
		void _copy(const LatticeAlternatingBinaryTraj& other);
	...
	public:
        ...
        LatticeAlternatingBinaryTraj(int no_dims, int box_length, std::vector<Sptr> species_visible);
		LatticeAlternatingBinaryTraj(const LatticeAlternatingBinaryTraj& other);
		LatticeAlternatingBinaryTraj(LatticeAlternatingBinaryTraj&& other);
		LatticeAlternatingBinaryTraj& operator=(const LatticeAlternatingBinaryTraj& other);
		LatticeAlternatingBinaryTraj& operator=(LatticeAlternatingBinaryTraj&& other);
		~LatticeAlternatingBinaryTraj();
