...
int main() {	
	...
	// Dimensions
	std::vector<Dim> dims;
	dims.push_back(Dim("hA",DimType::H,"A",{"hA","hB","hC"},-2.0,0.2,20,-1.0));
	dims.push_back(Dim("hB",DimType::H,"B",{"hA","hB","hC"},-1.2,0.2,20,-1.0));
	dims.push_back(Dim("hC",DimType::H,"C",{"hA","hB","hC"},-1.5,0.6,20,-1.0));
	...
	dims.push_back(Dim("jBB",DimType::J,"B","B",{"jAB","jBB","jBC"},-0.5,2.0,20,0.0));
	dims.push_back(Dim("jBC",DimType::J,"B","C",{"jBB","jBC","jCC"},-1.0,1.0,20,0.0));
