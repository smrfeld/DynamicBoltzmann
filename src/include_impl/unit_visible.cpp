...
namespace dblz {
	...
	********************/
	...
	std::vector<Sptr> UnitVisible::Impl::get_possible_species() const {
		return _sp_possible;
	};
	...
	std::shared_ptr<BiasDict> UnitVisible::Impl::get_bias_dict() const {
		return _bias_dict;
	};
	...
	********************/
	...
	std::vector<Sptr> UnitVisible::get_possible_species() const {
	...
	std::shared_ptr<BiasDict> UnitVisible::get_bias_dict() const {
